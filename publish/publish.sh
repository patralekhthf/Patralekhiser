...
ASSET="Patralekhiser-v1.2.0-preview.3.html"
...
#      cp <this folder>/Patralekhiser-v1.2.0-preview.3.html .
#      cp <this folder>/README.md .
#      git init -b main
#      git add .
#      git commit -m "Patralekhiser v1.2.0-preview.3: public test build"
